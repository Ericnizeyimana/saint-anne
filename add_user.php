...
if(isset($_POST['add'])){
    ...
    $INSERT = mysqli_query($conn,"INSERT INTO users (user_id,first_name,last_name,email,username,pass,created_at) values('','$fname',' $lname','$email','$username','$pass','$create')")or die(mysqli_error($conn));
    if($INSERT){
